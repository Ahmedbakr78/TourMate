...
// Get guide reviews
reviewRouter.get("/guide/:guideId", authentication, authorization([roleEnum.ADMIN, roleEnum.TOURIST]), reviewService.getGuideReviews);

// Get driver reviews
reviewRouter.get("/driver/:driverId", authentication, authorization([roleEnum.ADMIN, roleEnum.TOURIST]), reviewService.getDriverReviews);

// Get my reviews
reviewRouter.get("/my-reviews", authentication, reviewService.getMyReviews);
