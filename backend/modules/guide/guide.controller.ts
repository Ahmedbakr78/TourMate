...
// Update availability
guideRouter.patch("/update-availability/:id", authentication, authorization([roleEnum.ADMIN, roleEnum.GUIDE]), guideService.updateAvailability);

// Upload certificate
guideRouter.post("/upload-certificate/:id", authentication, authorization([roleEnum.ADMIN, roleEnum.GUIDE]), hostUpload([fileTypes.IMAGE, fileTypes.APPLICATION]).single("certificate"), guideService.uploadCertificate);

// Delete certificate
guideRouter.delete("/delete-certificate/:id", authentication, authorization([roleEnum.ADMIN, roleEnum.GUIDE]), guideService.deleteCertificate);
