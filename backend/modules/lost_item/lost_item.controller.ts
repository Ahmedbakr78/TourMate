...
// Report found item
lostItemRouter.patch("/:id/report-found", authentication, lostItemService.reportFoundItem);

// Close lost item
lostItemRouter.patch("/:id/close", authentication, lostItemService.closeLostItem);

// Reopen lost item
lostItemRouter.patch("/:id/reopen", authentication, lostItemService.reopenLostItem);
