...
class guideService {
    ...
    updateAvailability = async (req: IRequest, res: Response) => {
        ...
        if (typeof availability !== "boolean") throw new badRequestException("Availability must be a boolean");
        ...
        return res.json(successResponse("Availability updated successfully", 200, updatedGuide));
    };
    ...
    uploadCertificate = async (req: IRequest, res: Response) => {
        ...
        const filePath = req.file?.path;
        if (!filePath) throw new badRequestException("Certificate file is required");

        if (guide.certificate?.public_id) {
            await deleteFileFromCloudinary(guide.certificate.public_id);
        }
        ...
        return res.json(successResponse("Certificate uploaded successfully", 200, updatedGuide));
    };
    ...
    deleteCertificate = async (req: IRequest, res: Response) => {
        ...
        return res.json(successResponse("Certificate deleted successfully", 200, updatedGuide));
    };
